...
func (h *Router) apiUpload(w http.ResponseWriter, r *http.Request) {
	var (
	...
	if newPath == "" {
		OutJson(w, OutData{Code: -1, Success: false, Msg: "上传失败"})
		return
	}
	OutJson(w, OutData{Code: 200, Success: true, Result: newPath})
}
